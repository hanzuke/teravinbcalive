...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="${ctx.contextPath}/.resources/BCAproduk/webresources/css/magnific-popup.css">
  ...
  <!-- js placed at the end of the document so the pages load faster -->
	...
	<script type="text/javascript" src="${ctx.contextPath}/.resources/BCAproduk/webresources/js/jquery.parallax-1.1.3.js"></script>
    <script src="${ctx.contextPath}/.resources/BCAproduk/webresources/js/wow.min.js"></script>
    <script src="${ctx.contextPath}/.resources/BCAproduk/webresources/js/assets/owlcarousel/owl.carousel.js"></script>
    <script src="${ctx.contextPath}/.resources/BCAproduk/webresources/js/mixitup.js"></script>
    <script src="${ctx.contextPath}/.resources/BCAproduk/webresources/js/jquery.easing.min.js"></script>
	...
	<script src="${ctx.contextPath}/.resources/BCAproduk/webresources/js/jquery.magnific-popup.js"></script>
    <script src="${ctx.contextPath}/.resources/BCAproduk/webresources/js/wow.min.js"></script>
    <script>
        wow = new WOW(
          {
